            ...
            if resp.status_code == 200:
                ...
                if resp['code'] == 0:
                    if 'addExerciseRecord' in url:
                        exerciseRecordId = resp.get('exerciseRecordId')
                        if exerciseRecordId is None and isinstance(resp.get('data'), dict):
                            exerciseRecordId = resp['data'].get('id')
                        return resp.get('data'), exerciseRecordId
                    return resp['data']
