                ...
                try:
                    ...
                    if tsn_client.isPublic():
                        ...
                        try:
                            ...
                            if summary and 'data' in summary and summary['data'] and 'sportRange' in summary['data']:
                                total_distance = float(str(summary['data']['sportRange']).upper().replace('KM', '').strip())
                                record_count = int(summary['data'].get('sportTimes', 0))
                        except Exception as e:
                            logger.exception(e)
                                ...
                                while True:
                                    ...
                                    for record in record_list:
                                        ...
                                        if record_id not in last_record_ids:
                                            has_new_records = True
                                            if 'sportRange' in record:
                                                total_distance += float(record['sportRange'].upper().replace('KM', '').strip())
